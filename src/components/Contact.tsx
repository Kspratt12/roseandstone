    ...
    <section id="contact" className="py-20 md:py-28 bg-white">
      <div className="w-full max-w-[960px] mx-auto px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-14 text-center"
        >
          <div>
          ...
          <div>
            ...
            <div className="space-y-0.5 text-stone font-light text-[14px]">
              ...
              <p><a href="mailto:betty@roseandstonesalon.com" className="hover:text-blush transition-colors text-[13px]">betty@roseandstonesalon.com</a></p>
            </div>
          </div>
          <div>
            ...
            <div className="space-y-0.5 text-stone font-light text-[14px]">
              ...
              <p><a href="mailto:colourmebree@gmail.com" className="hover:text-blush transition-colors text-[13px]">colourmebree@gmail.com</a></p>
            </div>
          </div>
        </motion.div>
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" className="w-full px-4 py-2.5 bg-white border border-beige/40 rounded-lg focus:outline-none focus:border-blush/40 transition-all text-charcoal font-light text-[14px]" placeholder="First name" />
                </div>
                <div>
                  <label className="block text-[10px] text-charcoal/40 tracking-[0.12em] uppercase mb-1 font-light">Last Name</label>
                  <input type="text" className="w-full px-4 py-2.5 bg-white border border-beige/40 rounded-lg focus:outline-none focus:border-blush/40 transition-all text-charcoal font-light text-[14px]" placeholder="Last name" />
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] text-charcoal/40 tracking-[0.12em] uppercase mb-1 font-light">Email</label>
                  <input type="email" className="w-full px-4 py-2.5 bg-white border border-beige/40 rounded-lg focus:outline-none focus:border-blush/40 transition-all text-charcoal font-light text-[14px]" placeholder="your@email.com" />
                </div>
                <div>
                  <label className="block text-[10px] text-charcoal/40 tracking-[0.12em] uppercase mb-1 font-light">Phone</label>
                  <input type="tel" className="w-full px-4 py-2.5 bg-white border border-beige/40 rounded-lg focus:outline-none focus:border-blush/40 transition-all text-charcoal font-light text-[14px]" placeholder="(000) 000-0000" />
                </div>
              </div>
              <div>
