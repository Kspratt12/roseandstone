            ...
            <div className="flex-1 overflow-y-auto">
              {!selected ? (
                ...
                <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  >
                    <div className="w-16 h-16 rounded-full mb-4 mx-auto ring-2 ring-beige group-hover:ring-blush-light transition-colors bg-blush/10 flex items-center justify-center">
                      <span className="font-serif text-lg text-blush/60">BV</span>
                    </div>
                  ...
                  >
                    <div className="w-16 h-16 rounded-full mb-4 mx-auto ring-2 ring-beige group-hover:ring-blush-light transition-colors bg-blush/10 flex items-center justify-center">
                      <span className="font-serif text-lg text-blush/60">BS</span>
                    </div>
                    <h4 className="font-serif text-xl text-charcoal text-center mb-0.5">
                      Bree Szalkowski
                    </h4>
