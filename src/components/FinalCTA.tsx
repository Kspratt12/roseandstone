    ...
    <section className="py-24 md:py-32 bg-charcoal relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 text-center">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="inline-block mt-9 px-10 py-4 bg-blush text-white text-sm tracking-[0.15em] uppercase rounded-full hover:bg-blush-dark transition-all duration-300 shadow-lg shadow-blush/15 cursor-pointer"
        >
